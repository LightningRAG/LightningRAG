    ...
    <div class="flex flex-col md:flex-row gap-4">
      <div class="w-full md:w-1/2">
        <el-card class="min-w-96">
          <template #header>
            <el-divider>LightningRAG</el-divider>
          </template>
          <div>
            <div class="w-full flex items-center justify-center">
              <a href="https://github.com/LightningRAG/LightningRAG">
                  <img
            ...
            <div class="w-full flex items-center justify-around">
              <a href="https://github.com/LightningRAG/LightningRAG">
                  <img
                    class="dom-center"
                    src="https://img.shields.io/github/watchers/LightningRAG/LightningRAG.svg?label=Watch"
                    alt=""
                  />
                </a>
                <a href="https://github.com/LightningRAG/LightningRAG">
                  <img
                    class="dom-center"
                    src="https://img.shields.io/github/stars/LightningRAG/LightningRAG.svg?style=social"
                    alt=""
                  />
                </a>
                <a href="https://github.com/LightningRAG/LightningRAG">
                  <img
                    class="dom-center"
                    src="https://img.shields.io/github/forks/LightningRAG/LightningRAG.svg?label=Fork"
                    alt=""
                  />
                </a>
            </div>
            <div class="w-full flex justify-center mt-4">
              <el-link
                type="primary"
                href="https://lightningrag.com/license"
                target="_blank"
        ...
        <el-card class="min-w-96 mt-5">
          ...
          <div>
            <div class="w-full flex items-center justify-center">
                <a href="https://github.com/LightningRAG">
                  <img
                    class="org-img dom-center"
                    src="https://lightningrag.com/assets/logo.png"
                    alt="LightningRAG"
                  />
                </a>
              </div>
