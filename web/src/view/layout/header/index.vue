          ...
          <el-dropdown-menu>
            <el-dropdown-item>
              <span class="font-bold">
                {{ $t('layout.header.currentRole') }}{{ authorityDisplayName(userStore.userInfo.authority, t) }}
              </span>
            </el-dropdown-item>
            <template v-if="userStore.userInfo.authorities">
              ...
              >
                <span> {{ $t('layout.header.switchTo') }}{{ authorityDisplayName(item, t) }} </span>
              </el-dropdown-item>
            </template>
...
<script setup>
  ...
  const crumbTitle = (item) => {
    void locale.value
    return resolveMenuTitle(item.meta, route)
  }
