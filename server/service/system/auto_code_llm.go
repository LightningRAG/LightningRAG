...
import (
	...
	commonResp "github.com/LightningRAG/LightningRAG/server/model/common/response"
	"github.com/LightningRAG/LightningRAG/server/utils/request"
...
func (s *AutoCodeService) LLMAuto(ctx context.Context, llm common.JSONMap) (interface{}, error) {
	if global.LRAG_CONFIG.AutoCode.AiPath == "" {
	...
	path := strings.ReplaceAll(global.LRAG_CONFIG.AutoCode.AiPath, "{FUNC}", mode)
