	...
	tests := []struct {
	...
	}{
		{
			...
			fields: fields{
				...
				Path:        filepath.Join(global.LRAG_CONFIG.AutoCode.Root, global.LRAG_CONFIG.AutoCode.Server, "router", "example", "enter.go"),
				ImportPath:  `api "github.com/LightningRAG/LightningRAG/server/api/v1"`,
		...
		},
		{
			...
			fields: fields{
				...
				Path:        filepath.Join(global.LRAG_CONFIG.AutoCode.Root, global.LRAG_CONFIG.AutoCode.Server, "api", "v1", "example", "enter.go"),
				ImportPath:  `"github.com/LightningRAG/LightningRAG/server/service"`,
		...
		},
		{
			...
			fields: fields{
				...
				Path:        filepath.Join(global.LRAG_CONFIG.AutoCode.Root, global.LRAG_CONFIG.AutoCode.Server, "service", "example", "enter.go"),
				ImportPath:  ``,
