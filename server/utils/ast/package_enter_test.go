	...
	tests := []struct {
	...
	}{
		{
			...
			fields: fields{
				...
				Path:              filepath.Join(global.LRAG_CONFIG.AutoCode.Root, global.LRAG_CONFIG.AutoCode.Server, "api", "v1", "enter.go"),
				ImportPath:        `"github.com/LightningRAG/LightningRAG/server/api/v1/example"`,
		...
		},
		{
			...
			fields: fields{
				...
				Path:              filepath.Join(global.LRAG_CONFIG.AutoCode.Root, global.LRAG_CONFIG.AutoCode.Server, "router", "enter.go"),
				ImportPath:        `"github.com/LightningRAG/LightningRAG/server/router/example"`,
				StructName:        "Example",
				PackageName:       "example",
		...
		},
		{
			...
			fields: fields{
				...
				Path:              filepath.Join(global.LRAG_CONFIG.AutoCode.Root, global.LRAG_CONFIG.AutoCode.Server, "service", "enter.go"),
				ImportPath:        `"github.com/LightningRAG/LightningRAG/server/service/example"`,
