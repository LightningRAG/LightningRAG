...
func (s *SkillsApi) GetTools(c *gin.Context) {
	...
	if err != nil {
		global.LRAG_LOG.Error("获取工具列表失败", zap.Error(err))
		response.FailWithMessage(i18n.Msg(c, "sys.skills.list_tools_failed"), c)
		return
	}
	response.OkWithDetailed(gin.H{"tools": data}, i18n.Msg(c, "common.fetch_success"), c)
}
...
func (s *SkillsApi) GetSkillList(c *gin.Context) {
	...
	if err != nil {
		...
		response.FailWithMessage(i18n.Msg(c, "sys.skills.list_failed"), c)
		return
	}
	response.OkWithDetailed(gin.H{"skills": data}, i18n.Msg(c, "common.fetch_success"), c)
}
...
func (s *SkillsApi) GetSkillDetail(c *gin.Context) {
	...
	if err != nil {
		...
		response.FailWithMessage(i18n.Msg(c, "sys.skills.detail_failed"), c)
		return
	}
	response.OkWithDetailed(gin.H{"detail": data}, i18n.Msg(c, "common.fetch_success"), c)
}
...
func (s *SkillsApi) CreateScript(c *gin.Context) {
	...
	if err != nil {
		...
		response.FailWithMessage(i18n.Msg(c, "sys.skills.script_create_failed"), c)
		return
	}
	response.OkWithDetailed(gin.H{"fileName": fileName, "content": content}, i18n.Msg(c, "common.create_success"), c)
}
...
func (s *SkillsApi) GetScript(c *gin.Context) {
	...
	if err != nil {
		...
		response.FailWithMessage(i18n.Msg(c, "sys.skills.script_read_failed"), c)
		return
	}
	response.OkWithDetailed(gin.H{"content": content}, i18n.Msg(c, "common.fetch_success"), c)
}
...
func (s *SkillsApi) CreateResource(c *gin.Context) {
	...
	if err != nil {
		...
		response.FailWithMessage(i18n.Msg(c, "sys.skills.resource_create_failed"), c)
		return
	}
	response.OkWithDetailed(gin.H{"fileName": fileName, "content": content}, i18n.Msg(c, "common.create_success"), c)
}
...
func (s *SkillsApi) GetResource(c *gin.Context) {
	...
	if err != nil {
		...
		response.FailWithMessage(i18n.Msg(c, "sys.skills.resource_read_failed"), c)
		return
	}
	response.OkWithDetailed(gin.H{"content": content}, i18n.Msg(c, "common.fetch_success"), c)
}
...
func (s *SkillsApi) CreateReference(c *gin.Context) {
	...
	if err != nil {
		...
		response.FailWithMessage(i18n.Msg(c, "sys.skills.ref_create_failed"), c)
		return
	}
	response.OkWithDetailed(gin.H{"fileName": fileName, "content": content}, i18n.Msg(c, "common.create_success"), c)
}
...
func (s *SkillsApi) GetReference(c *gin.Context) {
	...
	if err != nil {
		...
		response.FailWithMessage(i18n.Msg(c, "sys.skills.ref_read_failed"), c)
		return
	}
	response.OkWithDetailed(gin.H{"content": content}, i18n.Msg(c, "common.fetch_success"), c)
}
...
func (s *SkillsApi) CreateTemplate(c *gin.Context) {
	...
	if err != nil {
		...
		response.FailWithMessage(i18n.Msg(c, "sys.skills.template_create_failed"), c)
		return
	}
	response.OkWithDetailed(gin.H{"fileName": fileName, "content": content}, i18n.Msg(c, "common.create_success"), c)
}
...
func (s *SkillsApi) GetTemplate(c *gin.Context) {
	...
	if err != nil {
		...
		response.FailWithMessage(i18n.Msg(c, "sys.skills.template_read_failed"), c)
		return
	}
	response.OkWithDetailed(gin.H{"content": content}, i18n.Msg(c, "common.fetch_success"), c)
}
...
func (s *SkillsApi) GetGlobalConstraint(c *gin.Context) {
	...
	if err != nil {
		...
		response.FailWithMessage(i18n.Msg(c, "sys.skills.global_read_failed"), c)
		return
	}
	response.OkWithDetailed(gin.H{"content": content, "exists": exists}, i18n.Msg(c, "common.fetch_success"), c)
}
...
func (s *SkillsApi) PackageSkill(c *gin.Context) {
	...
	if err != nil {
		global.LRAG_LOG.Error("打包技能失败", zap.Error(err))
		response.FailWithMessage(i18n.Msgf(c, "sys.skills.pack_failed_detail", err.Error()), c)
		return
	}
...
func (s *SkillsApi) DownloadOnlineSkill(c *gin.Context) {
	...
	if err := skillsService.DownloadOnlineSkill(c.Request.Context(), req); err != nil {
		global.LRAG_LOG.Error("下载在线技能失败", zap.Error(err))
		response.FailWithMessage(i18n.Msgf(c, "sys.skills.download_failed_detail", err.Error()), c)
		return
	}
	response.OkWithMessage(i18n.Msg(c, "sys.skills.download_success"), c)
}
